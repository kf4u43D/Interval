...
| Jeu | changement de clé/gamme 12-TET | 1–5, 7 | Validé logiciel; tablette reçue | oracle exhaustif de grille et reconfiguration avec libération des voix ; treize gammes standards en boutons directs ≥48 dp dans la V2.3 |
...
| Jeu | articulation pads arpégé/plaqué/muet | 3, 7 | Validé logiciel; tablette reçue partiellement | cycle autonome sans Tone Row, dix accords, ranges, doublures, revoicing, callbacks tardifs, Release et Panic couverts ; trois sélecteurs ≥48 dp reçus, écoute et MIDI USB ouvertes |
...
| UX | disposition deux mains adaptative | 1, 6–7 | Reçu sur tablette dans le périmètre testé | portrait forcé 900×1 440 dp : treize gammes/accords/strummer à gauche, utilitaires/intervalles à droite ; paysage également latéral sur SM-X620/API 36 |
| UX | cibles compactes, multi-touch, clavier et sémantiques | 1–7 | Reçu partiellement sur tablette | gammes, pads, accords, articulations et cordes ≥48 dp ; accord au touch-down et clic sémantique couverts, vrai multi-touch, TalkBack et contraste restent à recevoir |
...
| Performance | animation et rendu soutenus à 90 Hz | 2–3, 6 | Régression V2.1 corrigée; certification soutenue ouverte | baseline V2.1 cumulative p90 24 ms et 901/1 777 signaux de forte latence ; stress V2.2 Performance 108 frappes p50 14/p90 17/p95 18/p99 19 ms et 12/121 signaux. Fenêtres différentes, donc pas de preuve soutenue stricte |
...
| Robustesse UI | acteur musical indépendant du rendu et de l'I/O | 3, 6–7 | Validé logiciel; reçu nominalement | acteur, horloge, gates, one-shots et jobs d'arpège par source hors Main ; thread nommé à priorité audio fermé avec le ViewModel, persistance/diagnostics séparés |
...
| Robustesse générale | lifecycle prolongé, reprise audio et soak | 3–7 | V2.3 logicielle terminée; certification partielle | gate final 300/300 JVM, 2/2 natifs, cinq Lint, tous les assemblages et 8/8 instrumentés ; stress audio V2.2 conservé sans changement natif ; hotplug et soak non exécutés |
