...
| UX | disposition deux mains adaptative | 1, 6 | Reçu sur tablette dans le périmètre testé | portrait forcé 900×1 440 dp : harmonie/strummer à gauche, utilitaires/intervalles à droite ; paysage également latéral sur SM-X620/API 36 |
| UX | cibles compactes, multi-touch, clavier et sémantiques | 1–6 | Reçu partiellement sur tablette | pads, accords, articulations et cordes ≥48 dp couverts ; le strummer paysage passe de 22 dp fautifs à ≥48 dp, vrai multi-touch, TalkBack et contraste restent à recevoir |
...
| Robustesse UI | acteur musical indépendant du rendu et de l'I/O | 3, 6 | Validé logiciel; reçu nominalement | acteur, horloge, gates et one-shots hors Main ; V2.2 possède un thread nommé à priorité audio, fermé avec le ViewModel ; persistance/diagnostics restent séparés |
...
| Robustesse générale | lifecycle prolongé, reprise audio et soak | 3–6 | V2.2 logicielle terminée; certification partielle | gate final 297/297 JVM, 2/2 natifs, cinq Lint, tous les assemblages et 8/8 instrumentés ; stress audio 48 kHz/burst 96/buffer 192, queue 0/16, zéro xrun/drop/reprise/erreur ; hotplug et soak non exécutés |
