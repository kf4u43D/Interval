...
fun IntervalTabletApp(viewModel: IntervalTabletViewModel = viewModel()) {
    ...
    ProjectedPerformanceScreen(
        ...
        onSetArpeggiatorConfig = viewModel::setArpeggiatorConfig,
        onSetTempo = viewModel::setTempo,
        onSetClockDivision = viewModel::setClockDivision,
        onSetArpeggioGate = viewModel::setArpeggioGate,
