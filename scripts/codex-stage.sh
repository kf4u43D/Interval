...
case "$STAGE" in
    ...
    7) PROMPT="$ROOT/codex/prompts/07_v2_3_direct_harmony_arpeggio.md" ;;
    8) PROMPT="$ROOT/codex/prompts/08_v2_4_workstation_surface.md" ;;
    *) echo "Usage: $0 <1|2|3|4|5|6|7|8>" >&2; exit 2 ;;
esac
